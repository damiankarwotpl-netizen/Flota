...
4. Finish the remaining clothes workflow: XLSX exports and the remaining polish around the now-native order headers/items/history/issue/CSV slices.
5. Add real remote API wiring, notifications, background work, QA, and release hardening.

## Current count
**5 major implementation steps remain** after landing the local driver-account handoff, native vehicle-report PDF export, admin-side settings/report persistence, and the first clothes sizes/orders/items/history/issue/CSV slices.
