...
- the first clothes-module slices: native size management plus order headers/items/history backed by Room
...
4. finish the remaining clothes workflow pieces: issue flow and exports on top of the now-native order items/history flow
