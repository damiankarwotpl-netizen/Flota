...
- the first clothes-module slices: native size management plus order headers/items/history, basic issue actions, and CSV export backed by Room
...
4. finish the remaining clothes workflow pieces: XLSX export and final clothes polish on top of the now-native order items/history/issue/CSV flow
