...
- the first clothes-module slices: native size management plus order headers/items/history and basic issue actions backed by Room
...
4. finish the remaining clothes workflow pieces: exports and final clothes polish on top of the now-native order items/history/issue flow
