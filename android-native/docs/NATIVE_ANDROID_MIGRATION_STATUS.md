...
- the first clothes-module slice: native size management backed by Room
...
4. finish the remaining clothes workflow pieces: orders, issue flow, exports, and yearly stats
