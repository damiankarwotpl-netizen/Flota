...
sealed class AdminRoute(val route: String, val title: String) {
    ...
    data object VehicleReport : AdminRoute("vehicle_report", "Raport samochody")
    data object Clothes : AdminRoute("clothes", "Ubrania robocze")
    data object Payroll : AdminRoute("payroll", "Wypłaty")
    data object Housing : AdminRoute("housing", "Mieszkania")
