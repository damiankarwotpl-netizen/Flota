...
data class PayrollUiState(
    ...
    val isPreviewBulkSending: Boolean = false,
    val previewBulkProcessed: Int = 0,
    val previewBulkTotal: Int = 0,
    val previewBulkSent: Int = 0,
    val previewBulkSkipped: Int = 0,
    val previewBulkErrors: Int = 0,
    val isAwaitingMissingPeselConfirmation: Boolean = false,
    val missingPeselRowLabel: String = "",
    val applyMissingPeselDecisionToAll: Boolean = false,
